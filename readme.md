...
1. Prerequisites needed:
   - Advance Steel 2025 HF4;
   - Visual Studio 2026;
   - Dynamo Core 3.3.2 runtime from http://www.github.com/DynamoDS/Dynamo;
...
1. Copy all files and folders from "Dynamo Core 3.3.2" build to .\bin\AnyCPU\Release\steel-pkg\bin\Core
