...
1. Prerequisites needed:
   - Advance Steel 2027;
   - Visual Studio 2026;
   - Dynamo Core 4.0.0 runtime from http://www.github.com/DynamoDS/Dynamo;
...
1. Copy all files and folders from "Dynamo Core 4.0.0" build to .\bin\AnyCPU\Release\steel-pkg\bin\Core
